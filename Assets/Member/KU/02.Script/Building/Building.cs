...
public class Building : MonoBehaviour
{
    ...
    {
        TextMeshPro obj = Instantiate(_logPrefab, new Vector2(boxCollider.bounds.center.x+0.25f, boxCollider.bounds.center.y + buildingSO.width/buildingSO.maxW-1), Quaternion.identity,transform);
        if(isMinion)
        {
            obj.text = $"+미니언";
